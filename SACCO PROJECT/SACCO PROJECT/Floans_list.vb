...
Public Class Floans_list
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        MonthlyExp_StrBind = CType(DtaView.Item("Monthly_exp").ToString, String)
        ...
        txtLoan_Num.Text = LoanNum_StrBind
        ...
        txtLoan_Num.Text = LoanInterest_StrBind
    ...
    Public Sub DataConnection(ByVal DgV As DataGridView)
        ...
        With DgV
            ...
            .Columns(5).DataPropertyName = "Loan_Type"
            ...
            .Columns(5).HeaderText = "Loan_Type"
    ...
    Private Sub btnSave_Changes_Click(sender As Object, e As EventArgs) Handles btnSave_Changes.Click
        ...
        'ourconn.Close()
        'ourconn.Open()
        'Dim cmd = New MySqlCommand("UPDATE Loans SET MemberID=@OurMemberID,Name=@OurName where Loan_No='" & txtLoan_Num.Text.Trim & "'", ourconn)
