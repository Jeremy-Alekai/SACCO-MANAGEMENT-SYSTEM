...
Public Class Fsavings_view
    ...
    Private Sub Fsavings_view_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            With ourconn
                With MyDa
    ...
    Private Sub btnRefresh_Savingsview_Click(sender As Object, e As EventArgs) Handles btnRefresh_Savingsview.Click
        With MyDa
