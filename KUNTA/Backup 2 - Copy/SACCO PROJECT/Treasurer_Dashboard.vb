...
Public Class Treasurer_Dashboard
    ...
    Private Sub Treasurer_Dashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lbMemberID.Text = Login_Signup.txtMember_ID.Text
       


    End Sub

    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles lbMemberID.Click
