...
Public Class Fsavings
    ...
    Private Sub Fsavings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'lbSN.Text = manage_member.txtSN.Text
        Try
            With ourconn
                With MyDa
                    .SelectCommand = New MySqlCommand
                    .SelectCommand.CommandText = "SELECT * FROM personal_savings WHERE MEMBERID = '" + Member_Dashboard.MemberID_Dash.Text + "'"
                    .SelectCommand.Connection = ourconn
                    Dim Ole As New MySqlCommandBuilder(MyDa)
                    DtaSet.Clear()
                    .Fill(DtaSet, "personal_savings")
                    Call DataConnection(Me.DgvPSavings)
                End With
            End With
    ...
    Public Sub DataConnection(ByVal DgV As DataGridView)
        ...
        With DgV
            ...
            .Columns(5).DataPropertyName = "Residence"
            ...
            .Columns(5).HeaderText = "Residence"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnExport_Savings.Click
        DgvPSavings.RowsDefaultCellStyle.WrapMode = DataGridViewTriState.True
        ...
        Try
            ...
            xlApp.Visible = True
            rowsTotal = DgvPSavings.RowCount - 1
            colsTotal = DgvPSavings.Columns.Count - 1

            With excelWorksheet
                .Cells.Select()
                .Cells.Delete()
                For iC = 0 To colsTotal
                    .Cells(1, iC + 1).Value = DgvPSavings.Columns(iC).HeaderText
                Next
                ...
                For I = 0 To rowsTotal 'REMOVED THE - 1 to print the lasr row for the total
                    For j = 0 To colsTotal 'REMOVED THE - 1 to print the lasr column for the telephone
                        .Cells(I + 2, j + 1).value = DgvPSavings.Rows(I).Cells(j).Value
                    Next j
                Next I
    ...
    Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        ...
        DgvPSavings.DataSource = dset.Tables("personal_savings")


        DgvPSavings.Columns(0).DataPropertyName = "MemberID"
        DgvPSavings.Columns(1).DataPropertyName = "Name"
        DgvPSavings.Columns(2).DataPropertyName = "Tel"
        DgvPSavings.Columns(3).DataPropertyName = "Amount"
        DgvPSavings.Columns(4).DataPropertyName = "Deposit_Date"

        DgvPSavings.Columns(0).HeaderText = "Member ID"
        DgvPSavings.Columns(1).HeaderText = "Name"
        DgvPSavings.Columns(2).HeaderText = "Tel"
        DgvPSavings.Columns(3).HeaderText = "Amount"
        DgvPSavings.Columns(4).HeaderText = "Date"
        DgvPSavings.Columns(2).Width = 120
        DgvPSavings.Columns(4).Width = 200

        DgvPSavings.ReadOnly = True
        DgvPSavings.MultiSelect = False
        DgvPSavings.SelectionMode = DataGridViewSelectionMode.FullRowSelect
        DgvPSavings.ShowRowErrors = False
        DgvPSavings.ShowCellErrors = False
        DgvPSavings.AllowUserToAddRows = False ' Disabled or hide (*) Symbol...
        DgvPSavings.AllowUserToResizeColumns = False 'Disable HearderText Resize Column...
        DgvPSavings.AllowUserToResizeRows = False 'Disabled  row resize...
        DgvPSavings.RowHeadersVisible = False 'To hide Left indicator...
        DgvPSavings.DefaultCellStyle.SelectionBackColor = Color.SteelBlue  'Selection backcolor....
        DgvPSavings.DefaultCellStyle.ForeColor = Color.Black  'Selection backcolor....
        DgvPSavings.AlternatingRowsDefaultCellStyle.BackColor = Color.LightGoldenrodYellow 'Alternating Backcolor
    End Sub
