...
Public Class Floans_list
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnAdd_loan.Click
        Try
            Dim str As String = "INSERT INTO Loans(MemberID,Name,Employment_Postion,Payroll_num,Loan_interest,Monthly_NetIncome,Monthly_exp,My_Tel,email,Emp_name,Employer_tel,Emp_address,Terms_of_service,expiry_date,Position_in_sacco) VALUES('" & txtMemberID.Text & "','" & txtName.Text & "','" & txtEmp_position.Text & "','" & txtPayroll_num.Text & "','" & txtIoan_Interest.Text & "','" & txtNet_Income.Text & "','" & txtLoan.Text & "','" & txtMy_Tel.Text & "','" & txtEmail.Text & "','" & txtEmp_nam.Text & "','" & txtEmp_num.Text & "','" & txtEmp_Address.Text & "','" & cboTerms_of_service.Text & "','" & txtExpiry.Text & "','" & cboSACCO_Position.Text & "')"
            ourconn.Open()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        txtLoan.Text = MonthlyExp_StrBind
        ...
        txtNet_Income.Text = MonthlyNetIncome_StrBind
    ...
    Private Sub TextBox16_TextChanged(sender As Object, e As EventArgs) Handles txtNet_Income.TextChanged
    ...
    Private Sub btnSave_Changes_Click(sender As Object, e As EventArgs) Handles btnSave_Changes.Click
        Try
            ourconn.Close()
            ourconn.Open()
            Dim cmd = New MySqlCommand("UPDATE Loans SET MemberID=@OurMemberID,Name=@OurName,Employment_Postion=@OurEmployment_Postion,Payroll_num=@OurPayroll_num,Loan_interest=@OurLoan_interest,Monthly_NetIncome=@ourMonthly_NetIncome,Monthly_exp=@ourMonthly_exp,My_Tel=@ourMy_Tel,email=ouremail,Emp_name=ourEmp_name,Employer_tel=@ourEmployer_tel,Emp_address=@ourEmp_address,Terms_of_service=@ourTerms_of_service,expiry_date=@ourexpiry_date,Position_in_sacco=@ourPosition_in_sacco where Loan_No='" & LoanID.Text.Trim & "'", ourconn)
    ...
    Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        ...
        Dgv.Columns(5).DataPropertyName = "Loan_Type"
        ...
        Dgv.Columns(5).HeaderText = "Loan_Type"
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles Payback.TextChanged
        Payback.Text = CInt(txtIoan_Interest.Text) / 100 * CInt(txtLoan.Text)
    End Sub
